...
Struktur folder project sudah ada di:
  assets/images/character/   → sprite karakter
  assets/images/places/      → background tiap lab
  assets/audio/bgm/          → musik latar
  assets/audio/sfx/          → efek suara
...
*Generated for: Finding MrTC RenPy Game Project*  
*Asset path base: assets/ → di RenPy dipanggil langsung dari folder game/*
